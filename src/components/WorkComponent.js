          ...
          <div className="row">
            ...
            >
              <div
                className="project"
                style={{
                  backgroundImage: `url(${baseUrl}/assets/images/img-1.jpg)`
                }}
              >
                <div className="desc">
                  <div className="con">
            ...
            >
              <div
                className="project"
                style={{
                  backgroundImage: `url(${baseUrl}/assets/images/img-2.jpg)`
                }}
              >
                <div className="desc">
                  <div className="con">
            ...
            >
              <div
                className="project"
                style={{
                  backgroundImage: `url(${baseUrl}/assets/images/img-3.jpg)`
                }}
              >
                <div className="desc">
                  <div className="con">
            ...
            >
              <div
                className="project"
                style={{
                  backgroundImage: `url(${baseUrl}/assets/images/img-4.jpg)`
                }}
              >
                <div className="desc">
                  <div className="con">
            ...
            >
              <div
                className="project"
                style={{
                  backgroundImage: `url(${baseUrl}/assets/images/img-5.jpg)`
                }}
              >
                <div className="desc">
                  <div className="con">
            ...
            >
              <div
                className="project"
                style={{
                  backgroundImage: `url(${baseUrl}/assets/images/img-6.jpg)`
                }}
              >
                <div className="desc">
                  <div className="con">
